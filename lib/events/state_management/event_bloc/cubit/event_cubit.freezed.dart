...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( EventInitial value)?  initial,TResult Function( EventLoading value)?  loading,TResult Function( EventLoaded value)?  loaded,TResult Function( EventError value)?  error,TResult Function( TodayEventsLoaded value)?  todayEventsLoaded,required TResult orElse(),}){
final _that = this;
switch (_that) {
case EventInitial() when initial != null:
return initial(_that);case EventLoading() when loading != null:
return loading(_that);case EventLoaded() when loaded != null:
return loaded(_that);case EventError() when error != null:
return error(_that);case TodayEventsLoaded() when todayEventsLoaded != null:
return todayEventsLoaded(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( EventInitial value)  initial,required TResult Function( EventLoading value)  loading,required TResult Function( EventLoaded value)  loaded,required TResult Function( EventError value)  error,required TResult Function( TodayEventsLoaded value)  todayEventsLoaded,}){
final _that = this;
switch (_that) {
case EventInitial():
return initial(_that);case EventLoading():
return loading(_that);case EventLoaded():
return loaded(_that);case EventError():
return error(_that);case TodayEventsLoaded():
return todayEventsLoaded(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( EventInitial value)?  initial,TResult? Function( EventLoading value)?  loading,TResult? Function( EventLoaded value)?  loaded,TResult? Function( EventError value)?  error,TResult? Function( TodayEventsLoaded value)?  todayEventsLoaded,}){
final _that = this;
switch (_that) {
case EventInitial() when initial != null:
return initial(_that);case EventLoading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Event> events)?  loaded,TResult Function( String message)?  error,TResult Function( List<Event> events)?  todayEventsLoaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case EventInitial() when initial != null:
return initial();case EventLoading() when loading != null:
return loading();case EventLoaded() when loaded != null:
return loaded(_that.events);case EventError() when error != null:
return error(_that.message);case TodayEventsLoaded() when todayEventsLoaded != null:
return todayEventsLoaded(_that.events);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Event> events)  loaded,required TResult Function( String message)  error,required TResult Function( List<Event> events)  todayEventsLoaded,}) {final _that = this;
switch (_that) {
case EventInitial():
return initial();case EventLoading():
return loading();case EventLoaded():
return loaded(_that.events);case EventError():
return error(_that.message);case TodayEventsLoaded():
return todayEventsLoaded(_that.events);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Event> events)?  loaded,TResult? Function( String message)?  error,TResult? Function( List<Event> events)?  todayEventsLoaded,}) {final _that = this;
switch (_that) {
case EventInitial() when initial != null:
return initial();case EventLoading() when loading != null:
return loading();case EventLoaded() when loaded != null:
