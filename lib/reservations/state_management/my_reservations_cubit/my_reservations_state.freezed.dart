...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MyReservationsState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MyReservationsState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MyReservationsState value)  $default,){
final _that = this;
switch (_that) {
case _MyReservationsState():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MyReservationsState value)?  $default,){
final _that = this;
switch (_that) {
case _MyReservationsState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool isCancelling,  List<Reservation> upcomingReservations,  List<Reservation> pastReservations,  List<Reservation> cancelledReservations,  String? error,  String? success)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MyReservationsState() when $default != null:
return $default(_that.isLoading,_that.isCancelling,_that.upcomingReservations,_that.pastReservations,_that.cancelledReservations,_that.error,_that.success);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool isCancelling,  List<Reservation> upcomingReservations,  List<Reservation> pastReservations,  List<Reservation> cancelledReservations,  String? error,  String? success)  $default,) {final _that = this;
switch (_that) {
case _MyReservationsState():
return $default(_that.isLoading,_that.isCancelling,_that.upcomingReservations,_that.pastReservations,_that.cancelledReservations,_that.error,_that.success);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool isCancelling,  List<Reservation> upcomingReservations,  List<Reservation> pastReservations,  List<Reservation> cancelledReservations,  String? error,  String? success)?  $default,) {final _that = this;
switch (_that) {
case _MyReservationsState() when $default != null:
return $default(_that.isLoading,_that.isCancelling,_that.upcomingReservations,_that.pastReservations,_that.cancelledReservations,_that.error,_that.success);case _:
  return null;
