...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  List<ReservationTimeSlot> availableSlots,  List<ReservationTimeSlot> nextAvailableSlots,  ReservationTimeSlot? selectedSlot,  DateTime? selectedDate,  String? error,  String? success)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookingState() when $default != null:
return $default(_that.isLoading,_that.availableSlots,_that.nextAvailableSlots,_that.selectedSlot,_that.selectedDate,_that.error,_that.success);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  List<ReservationTimeSlot> availableSlots,  List<ReservationTimeSlot> nextAvailableSlots,  ReservationTimeSlot? selectedSlot,  DateTime? selectedDate,  String? error,  String? success)  $default,) {final _that = this;
switch (_that) {
case _BookingState():
return $default(_that.isLoading,_that.availableSlots,_that.nextAvailableSlots,_that.selectedSlot,_that.selectedDate,_that.error,_that.success);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  List<ReservationTimeSlot> availableSlots,  List<ReservationTimeSlot> nextAvailableSlots,  ReservationTimeSlot? selectedSlot,  DateTime? selectedDate,  String? error,  String? success)?  $default,) {final _that = this;
switch (_that) {
case _BookingState() when $default != null:
return $default(_that.isLoading,_that.availableSlots,_that.nextAvailableSlots,_that.selectedSlot,_that.selectedDate,_that.error,_that.success);case _:
  return null;
