...
mixin _$Place {
 ...
 String get id; String get name; String get description; String get address; double get averagePrice; List<String> get imageUrls; double get rating; List<Review> get reviews; List<Offer> get offers; List<String> get tags; bool get isOpen; List<Schedule> get schedules; String get mainImage; int get favoriteCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,address,averagePrice,const DeepCollectionEquality().hash(imageUrls),rating,const DeepCollectionEquality().hash(reviews),const DeepCollectionEquality().hash(offers),const DeepCollectionEquality().hash(tags),isOpen,const DeepCollectionEquality().hash(schedules),mainImage,favoriteCount);

@override
String toString() {
  return 'Place(id: $id, name: $name, description: $description, address: $address, averagePrice: $averagePrice, imageUrls: $imageUrls, rating: $rating, reviews: $reviews, offers: $offers, tags: $tags, isOpen: $isOpen, schedules: $schedules, mainImage: $mainImage, favoriteCount: $favoriteCount)';
}
...
@useResult
$Res call({
 String id, String name, String description, String address, double averagePrice, List<String> imageUrls, double rating, List<Review> reviews, List<Offer> offers, List<String> tags, bool isOpen, List<Schedule> schedules, String mainImage, int favoriteCount
});
...
class _Place implements Place {
  const _Place({required this.id, required this.name, required this.description, required this.address, required this.averagePrice, required final  List<String> imageUrls, required this.rating, required final  List<Review> reviews, final  List<Offer> offers = const [], final  List<String> tags = const [], this.isOpen = false, final  List<Schedule> schedules = const [], this.mainImage = "", this.favoriteCount = 0}): _imageUrls = imageUrls,_reviews = reviews,_offers = offers,_tags = tags,_schedules = schedules;
