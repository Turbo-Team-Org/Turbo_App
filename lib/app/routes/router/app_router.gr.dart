...
import 'package:turbo/reservations/presentation/screens/reservation_details_page.dart'
    as _i15;
import 'package:turbo/users/presentation/screens/profile_screen.dart' as _i14;

/// generated route for
/// [_i1.BookingFormPage]
class BookingFormRoute extends _i20.PageRouteInfo<BookingFormRouteArgs> {
  BookingFormRoute({
    _i21.Key? key,
    required String placeId,
    required String placeName,
    required DateTime selectedDate,
    required _i22.ReservationTimeSlot selectedSlot,
...
class BookingFormRouteArgs {
  ...
  final _i22.ReservationTimeSlot selectedSlot;
...
/// generated route for
/// [_i2.BookingPage]
class BookingRoute extends _i20.PageRouteInfo<BookingRouteArgs> {
  BookingRoute({
    _i21.Key? key,
    required String placeId,
    required String placeName,
...
class BottomNavShellWidget extends _i20.PageRouteInfo<void> {
  const BottomNavShellWidget({List<_i20.PageRouteInfo>? children})
...
class BusinessDetailsRoute
    extends _i20.PageRouteInfo<BusinessDetailsRouteArgs> {
...
class CategoryDetailsRoute
    extends _i20.PageRouteInfo<CategoryDetailsRouteArgs> {
...
class FeedRoute extends _i20.PageRouteInfo<void> {
  const FeedRoute({List<_i20.PageRouteInfo>? children})
...
class MyReservationsRoute extends _i20.PageRouteInfo<void> {
  const MyReservationsRoute({List<_i20.PageRouteInfo>? children})
...
/// generated route for
/// [_i12.PlacesSearchScreen]
class PlacesSearchRoute extends _i20.PageRouteInfo<PlacesSearchRouteArgs> {
  PlacesSearchRoute({
    _i21.Key? key,
    String? categoryId,
    String? categoryName,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i12.PlacesSearchScreen(
        key: args.key,
...
/// generated route for
/// [_i13.PlacesShowcaseScreen]
class PlacesShowcaseRoute extends _i20.PageRouteInfo<void> {
  const PlacesShowcaseRoute({List<_i20.PageRouteInfo>? children})
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i13.PlacesShowcaseScreen();
    },
  );
}
...
/// generated route for
/// [_i15.ReservationDetailsPage]
class ReservationDetailsRoute
    extends _i20.PageRouteInfo<ReservationDetailsRouteArgs> {
  ReservationDetailsRoute({
    _i21.Key? key,
    required String reservationId,
    _i22.Reservation? reservation,
    List<_i20.PageRouteInfo>? children,
  }) : super(
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i15.ReservationDetailsPage(
        key: args.key,
...
class ReservationDetailsRouteArgs {
  ...
  final _i22.Reservation? reservation;
...
class SignInRoute extends _i20.PageRouteInfo<SignInRouteArgs> {
  SignInRoute({_i21.Key? key, List<_i20.PageRouteInfo>? children})
    : super(
        SignInRoute.name,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i16.SignInScreen(key: args.key);
    },
  );
}
...
class SignUpRoute extends _i20.PageRouteInfo<SignUpRouteArgs> {
  SignUpRoute({_i21.Key? key, List<_i20.PageRouteInfo>? children})
    : super(
        SignUpRoute.name,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i17.SignUpScreen(key: args.key);
    },
  );
}
...
/// generated route for
/// [_i19.TurboSplashScreen]
class TurboSplashRoute extends _i20.PageRouteInfo<void> {
  const TurboSplashRoute({List<_i20.PageRouteInfo>? children})
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    name,
    builder: (data) {
      return const _i19.TurboSplashScreen();
    },
  );
}
