...
class BottomNavShellWidget extends _i13.PageRouteInfo<void> {
  const BottomNavShellWidget({List<_i13.PageRouteInfo>? children})
...
class BusinessDetailsRoute
    extends _i13.PageRouteInfo<BusinessDetailsRouteArgs> {
...
class PlacesShowcaseRoute extends _i13.PageRouteInfo<void> {
  const PlacesShowcaseRoute({List<_i13.PageRouteInfo>? children})
...
class SignInRoute extends _i13.PageRouteInfo<SignInRouteArgs> {
  SignInRoute({_i14.Key? key, List<_i13.PageRouteInfo>? children})
    : super(
        SignInRoute.name,
...
class SignUpRoute extends _i13.PageRouteInfo<SignUpRouteArgs> {
  SignUpRoute({_i14.Key? key, List<_i13.PageRouteInfo>? children})
    : super(
        SignUpRoute.name,
